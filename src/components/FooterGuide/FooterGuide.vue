...
<div class="footer_guide">
    <span class="guide_item" :class="{on: $route.path==='/msite'}" @click="goto('/msite')">
      <span class="item_icon">
        <i class="iconfont icon-xingzhuanggongnengtubiao-4"></i>  <!--首页-->
      </span>
      <span>外卖</span>
    </span>
    <span class="guide_item" :class="{on:$route.path==='/search'}" @click="goto('/search')">
        <span class="item_icon">
          <i class="iconfont icon-xingzhuanggongnengtubiao-12"></i> <!--搜索-->
        </span>
        <span>搜索</span>
    </span>
    <span class="guide_item" :class="{on: $route.path==='/order'}" @click="goto('/order')">
        <span class="item_icon">
          <i class="iconfont icon-xingzhuanggongnengtubiao-3"></i>  <!--订单-->
        </span>
        <span>订单</span>
    </span>
    <span class="guide_item" :class="{on:$route.path==='/profile'}" @click="goto('/profile')">
        <span class="item_icon">
          <i class="iconfont icon-xingzhuanggongnengtubiao-1"></i>  <!--我的-->
        </span>
        <span>我的</span>
    </span>
</div>
