      ...
      <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow">
        <div class="discounts-left">
          <div class="activity" :class="supportClasses[info.supports[0].type]">
            ...
            <span class="activity">{{info.supports[0].content}}</span>
          </div>
        </div>
      ...
      <transition name="fade">
        <div class="shop-brief-modal" v-show="shopShow">
          <div class="brief-modal-content">
            ...
            <div class="brief-modal-notice" @click="getHeader">{{info.bulletin}}</div>
          ...
          <div class="detail-wrapper clearFix">
            <div class="detail-main">
              ...
              <div class="star-wrapper">
                <Star :score="info.score" :size="48"></Star>
              </div>
              <div class="title">
                <div class="line"></div>
              ...
              <ul class="supports" v-if="info.supports">
                <li class="support-item" v-for="(support,index) in info.supports" :key="index">
                  <span class="icon" :class="classMap[support.type]"></span>
                  <span class="text">{{support.content}}</span>
                </li>
              </ul>
              <div class="supports" v-else>暂无优惠信息</div>
              <div class="title">
                <div class="line"></div>
...
<script>
  ...
  export default {
    data(){
      return {
        supportClasses:['activity-red','activity-green','activity-orange'],
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .shop-header
    ...
    .activity-sheet
      ...
      height: 100%;
      z-index: 99;
      &.fada-enter-active,&fada-leave-active
        transition opacity 1s
      &.fada-enter, &.fada-leave-to
        opacity 0
