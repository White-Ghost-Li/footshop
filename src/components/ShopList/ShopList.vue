<template>
  <div class="shop_container">
    <ul class="shop_list" v-if="shops.length">
      <li class="shop_li border-1px"  v-for="(shop,index) in shops" :key="index"  @click="hit(shop.id)">
        <router-link to="/shop">
          <div class="shop_left">
            <img src="./image/title.png" class="shop_img"/>  <!--:src="baseImageUrl+shop.image_path"-->
          </div>
    ...
    <ul class="shop_list"  v-for="i in 4" v-show="false"><!-- v-else>-->
      <li>
        <img src="" alt="back"/>
      </li>
    </ul>
